...
const Index = () => {
  ...
  const episodes = [
    { 
      ...
      nextEpisode: {
        title: "Скоро: Полосатые хищники",
        preview: "В следующем месяце познакомимся с тиграми разных видов, узнаем об их жизни в дикой природе и программах по их защите!"
      }
    },
    { 
      number: 17, 
    ...
    { number: 16, title: "Как помочь животным", date: "Май 2025", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", description: "Каждый может помочь природе! Узнай простые способы, как дети и взрослые защищают животных и их дома.", nextEpisode: { title: "Скоро: Яркая мандаринка", preview: "В апреле познакомимся с самой красочной уткой в мире — узнаем о её удивительных переливающихся перьях!" } },
    { number: 15, title: "Яркая мандаринка", date: "Апрель 2025", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", description: "Мандаринка — самая красочная утка в мире. Смотри, как она плавает и почему её перья переливаются всеми цветами радуги.", nextEpisode: { title: "Скоро: С улыбкой из Австралии", preview: "В марте встретимся с квоккой — самым счастливым животным планеты, которое всегда улыбается!" } },
    { number: 14, title: "С улыбкой из Австралии", date: "Март 2025", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", description: "Квокка — самое счастливое животное планеты. Узнай, почему эти зверьки всегда улыбаются и где их можно встретить.", nextEpisode: { title: "Скоро: Бабочка — хрупкая красота", preview: "В феврале узнаем удивительную историю превращения гусеницы в прекрасную бабочку!" } },
    { number: 13, title: "Бабочка: хрупкая красота", date: "Февраль 2025", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", description: "Удивительный мир бабочек: от крошечной гусеницы до прекрасного крылатого создания. Узнай о самых красивых видах планеты.", nextEpisode: { title: "Скоро: Замечательные ослики", preview: "В январе познакомимся с умными и выносливыми осликами — верными друзьями человека!" } },
    { number: 12, title: "Замечательные ослики", date: "Январь 2025", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", description: "Ослики — верные друзья человека. Узнай, почему они такие умные, выносливые и как помогают людям уже тысячи лет.", nextEpisode: { title: "Скоро: Змеи — страшные, но интересные", preview: "В декабре узнаем правду о змеях: почему они важны для природы и как себя вести при встрече!" } },
    { number: 11, title: "Змеи: страшные, но интересные", date: "Декабрь 2024", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", description: "Узнай удивительные факты о самых необычных змеях планеты. Почему они так важны для природы и как себя вести при встрече с ними.", nextEpisode: { title: "Скоро: Мировые редкости", preview: "В ноябре познакомимся с самыми редкими животными Земли и программами их защиты!" } },
